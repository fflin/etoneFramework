...
package com.etone.framework.component.bitmap.callback;
...
import com.etone.framework.component.bitmap.BitmapDisplayConfig;
...
public abstract class BitmapLoadCallBack<T extends View> {
    ...
    public void setBitmap(T container, Bitmap bitmap, boolean defaultAnimation)
    {
        ...
        {
            if (defaultAnimation /*&& Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP_MR1*/)
            {
                TransitionDrawable td = new TransitionDrawable(new Drawable[]{new ColorDrawable(0xffc8c7cc), new BitmapDrawable(container.getResources(), bitmap)});
                ((ImageView) container).setImageDrawable(td);
