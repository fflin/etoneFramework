...
import com.etone.framework.component.bitmap.core.BitmapCache;
import com.etone.framework.component.bitmap.download.DefaultDownloader;
...
import com.etone.framework.utils.OtherUtils;
import com.etone.framework.task.Priority;
...
public class BitmapGlobalConfig {
    ...
    private final static HashMap<String, BitmapGlobalConfig> configMap = new HashMap<>(1);
