...
package com.etone.framework.component.bitmap;
...
import com.etone.framework.component.bitmap.callback.BitmapLoadCallBack;
import com.etone.framework.component.bitmap.callback.BitmapLoadFrom;
import com.etone.framework.component.bitmap.callback.DefaultBitmapLoadCallBack;
import com.etone.framework.component.bitmap.core.AsyncDrawable;
import com.etone.framework.component.bitmap.core.BitmapSize;
import com.etone.framework.component.bitmap.download.Downloader;
import com.etone.framework.cache.FileNameGenerator;
import com.etone.framework.task.PriorityAsyncTask;
import com.etone.framework.task.PriorityExecutor;
import com.etone.framework.task.TaskHandler;
...
public class BitmapUtils implements TaskHandler {
    ...
    public BitmapUtils configDefaultAnimation(boolean flag)
    {
        defaultDisplayConfig.defaultAnimation = flag;
        return this;
    }
    ...
    public static String isNeedEncodeUrl(String url)
    {

        if (null != url && isChineseCharacter(url))
        {
            try
            {
                String uri = URLEncoder.encode(url, "UTF-8").
                        replaceAll("\\+", "%20").replaceAll("%3A", ":").replaceAll("%2F", "/");
                LogUtils.e("头像编码之后" + uri);
                return uri;
            }
